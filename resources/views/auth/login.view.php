    ...
    <div class="login-container">
        ...
        <form action="/loginForm" method="post">
            ...
            <div class="input-container">
                <div>
                    <input type="text" name="login" id="login" placeholder="username/email" value="<?= old('login') ?>" <?= isInvalid('login') ?> class="focus:ring-2 focus:ring-[#815331] focus:border-[#815331] transition-all">
