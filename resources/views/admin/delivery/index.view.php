...
<div class="custom-datatable bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200 my-4">
    <table id="delivery-table" class="w-full border-collapse text-sm">
        <thead class="bg-gray-50">
            <tr>
                <th
                    class="px-5 py-4 text-left font-semibold text-gray-700 text-xs uppercase tracking-wide border-b border-gray-200">
                    ID</th>
                <th
                    class="px-5 py-4 text-left font-semibold text-gray-700 text-xs uppercase tracking-wide border-b border-gray-200">
                    Item name</th>
                ...
                <th
                    ...
                    Date</th>
                <th
                    class="px-5 py-4 text-right font-semibold text-gray-700 text-xs uppercase tracking-wide border-b border-gray-200">
                    Action</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr class="hover:bg-gray-50 transition-colors duration-150">
                <td class="px-5 py-4 border-b border-gray-100 text-gray-600 font-semibold font-mono">
                    #<?= str_pad($delivery->id, 4, '0', STR_PAD_LEFT) ?></td>
                <td class="px-5 py-4 border-b border-gray-100 text-gray-900 font-medium">
                    <?= htmlspecialchars($delivery->order->orderItems[0]->items->item_name) ?></td>
                <td class="px-5 py-4 border-b border-gray-100 text-gray-600">
                    <?= htmlspecialchars($delivery->order->user->name) ?>
                </td>
                <td class="px-5 py-4 border-b border-gray-100 text-green-600 font-semibold">
                    ₱<?= number_format($delivery->order->total_amount, 2) ?></td>
                <td class="px-5 py-4 border-b border-gray-100">
                    <?php if ($delivery->status === "scheduled"): ?>
                    <span
                        class="inline-block px-3 py-1 rounded-full text-xs font-medium text-center min-w-[80px] bg-yellow-50 text-yellow-600 border border-yellow-200">Scheduled</span>
                    <?php elseif ($delivery->status === "rescheduled"): ?>
                    <span
                        class="inline-block px-3 py-1 rounded-full text-xs font-medium text-center min-w-[80px] bg-orange-50 text-orange-600 border border-orange-200">Rescheduled</span>
                    <?php elseif ($delivery->status === "in_transit"): ?>
                    <span
                        class="inline-block px-3 py-1 rounded-full text-xs font-medium text-center min-w-[80px] bg-blue-50 text-blue-600 border border-blue-200">In
                        Transit</span>
                    <?php elseif ($delivery->status === "delivered"): ?>
                    <span
                        class="inline-block px-3 py-1 rounded-full text-xs font-medium text-center min-w-[80px] bg-green-50 text-green-600 border border-green-200">Delivered</span>
                    <?php elseif ($delivery->status === "failed"): ?>
                    <span
                        class="inline-block px-3 py-1 rounded-full text-xs font-medium text-center min-w-[80px] bg-red-100 text-red-600 border border-red-300">Failed</span>
                    <?php endif ?>
                </td>
                <td class="px-5 py-4 border-b border-gray-100">
                ...
                <td class="px-5 py-4 border-b border-gray-100">
                    <div class="flex gap-2 items-center">
                        <a href="/admin/inventory/show/<?= $delivery->id ?>"
                        ...
                        <a href="/admin/inventory/edit/<?= $delivery->id ?>"
                        ...
                        <a href="/admin/inventory/delete/<?= $delivery->id ?>"
