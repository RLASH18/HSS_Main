...
<div class="mb-4 sm:mb-8">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="mb-2 text-2xl sm:text-3xl font-bold text-black-900">Shopping Cart</h1>
            <p class="text-sm sm:text-base text-black-600">Review your items and proceed to checkout</p>
        </div>
...
<?php else: ?>
    ...
    <div class="grid grid-cols-1 gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-3">
        ...
        <div class="space-y-3 sm:space-y-4 lg:col-span-2">
            <!-- Select all header -->
            <div class="p-3 sm:p-4 bg-white border border-b border-gray-100 rounded-lg shadow-sm">
                <div class="flex items-center justify-between">
                    <label class="flex items-center space-x-2 sm:space-x-3 cursor-pointer">
                        <input type="checkbox" id="selectAll" class="w-4 h-4 sm:w-5 sm:h-5 text-[#815331] border-gray-300 rounded focus:ring-[#815331]">
                        <span class="text-sm sm:text-base font-medium text-gray-900">Select all items</span>
                    </label>
                    <span class="text-xs sm:text-sm text-gray-600"><?= count($carts) ?> item(s)</span>
                </div>
            </div>
            ...
            ?>
                <div class="p-3 sm:p-4 lg:p-6 bg-white border border-gray-100 rounded-lg shadow-sm cart-item">
                    <div class="flex items-start gap-2 sm:gap-3 lg:gap-4">
                        <!-- checkbox -->
                        <div class="flex-shrink-0 pt-1 sm:pt-2">
                            <input type="checkbox" class="item-checkbox w-4 h-4 sm:w-5 sm:h-5 text-[#815331] border-gray-300 rounded focus:ring-[#815331]"
                        ...
                        <div class="flex-shrink-0">
                            <img src="/storage/items-img/<?= $cart->item->item_image_1 ?>" alt="<?= $cart->item->item_name ?>"
                                class="object-cover w-16 h-16 sm:w-20 sm:h-20 border border-gray-200 rounded-lg">
                        </div>

                        <!-- Item details -->
                        <div class="flex-1 min-w-0">
                            <h3 class="mb-1 text-sm sm:text-base lg:text-lg font-semibold text-gray-900 line-clamp-2"><?= $cart->item->item_name ?></h3>
                            <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                                <span class="text-base sm:text-lg font-bold text-[#815331]">₱<?= number_format($cart->item->unit_price, 2) ?></span>
                                <span class="text-xs sm:text-sm text-gray-500">per units</span>
                            </div>
                        </div>
                        ...
                        <div class="flex-shrink-0">
                            <div class="flex flex-col items-end gap-2 sm:gap-3">
                                <!-- Quantity adjusters -->
                                <div class="flex items-center border border-gray-300 rounded-lg text-sm sm:text-base">
                                    <!-- Decrease quantity -->
                                    ...
                                    <input type="number" class="qty-input w-12 sm:w-16 px-1 sm:px-2 py-1 text-sm sm:text-base font-medium text-center text-gray-900 border-0 focus:ring-0 focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                ...
                                <div class="text-right">
                                    <div class="text-base sm:text-lg font-bold text-gray-900 item-total">₱<?= number_format($itemTotal, 2) ?></div>
                    ...
                    <?php if ($cart->item->quantity < 10): ?>
                        <div class="p-2 mt-2 sm:mt-3 border border-orange-200 rounded-lg bg-orange-50">
        ...
        <div class="lg:col-span-1">
            <div class="sticky p-4 sm:p-6 bg-white border border-gray-100 rounded-lg shadow-sm top-4 sm:top-8">
                ...
                <div class="mb-4 sm:mb-6 space-y-2 sm:space-y-3">
                    ...
                    <div class="pt-2 sm:pt-3 border-t">
                        <div class="flex justify-between">
                            ...
                            <span class="text-base sm:text-lg font-bold text-[#815331]" id="selectedTotal">₱0.00</span>
                        </div>
                    </div>
                </div>
                ...
                <button type="button" id="checkoutBtn"
                    class="w-full bg-[#815331] text-white font-semibold py-2 sm:py-3 px-4 text-sm sm:text-base rounded-lg hover:bg-[#6d4529] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                    disabled>
                    Proceed to Checkout
                </button>
            </div>
