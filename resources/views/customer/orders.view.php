                        ...
                        <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                            <div class="flex items-center justify-center text-center">
                                <div class="flex flex-col items-center">
                                    <div class="w-10 h-10 rounded-full bg-red-500 flex items-center justify-center mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-red-700 mb-1">Order Cancelled</h3>
                                    <p class="text-sm text-red-600 mb-2">This order has been cancelled by the administrator</p>
